...
export function SkeletonBookCard() {
  return (
    <div className="animate-pulse bg-slate-100 dark:bg-slate-700 rounded-lg p-4">
...
export function SkeletonElementCard() {
  return (
    <div className="animate-pulse border border-slate-200 dark:border-slate-700 rounded-lg p-4 bg-white dark:bg-slate-800">
      ...
      <div className="h-4 bg-slate-200 dark:bg-slate-700 rounded w-5/6 mt-1"></div>
    </div>
  );
}
    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-700">
      <div className="animate-pulse">
        ...
        <div className="space-y-3 mb-4">
          ...
          <div className="h-4 bg-slate-200 dark:bg-slate-700 rounded w-9/12"></div>
        </div>
